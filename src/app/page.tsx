...
import { PULSY_TOKENS, solanaExplorerUrl } from "@/lib/pulsy-tokens";
...
const TIERS = [
  {
    ...
    label: "PACK 01",
    image: "/trencher1.png",
    note: "Start here. Three Solana rewards from the Pulsy reserve list.",
  },
  {
    name: "Ansem Signal",
    price: 50,
...
export default function PulsyPage() {
  ...
  return (
    <main id="top" className="hp-shell">
      <div className="hp-announcement">
        <span>Pulsy Solana pack migration in progress</span>
      ...
      <section id="packs" className="hp-workbench" aria-labelledby="pack-heading">
        ...
        >
          <div className="hp-kicker">
            <span>SOLANA TOKEN PACKS / PULSY</span>
          ...
          <p>
            Pulsy is the Solana version of the pack experience: connect a Solana wallet, preview a
            three-token pull, and stage rewards around SOL, ETH, ANSEM, and JIMOTHY.
          </p>
          <div className="hp-pool-strip" aria-label="Four Solana assets in the Pulsy pool">
            {PULSY_TOKENS.map((token) => (
        ...
        <div className="hp-control-panel">
          <div className="hp-panel-head">
            <div>
              ...
              <strong>PULSY MENU</strong>
            </div>
            <span className="hp-series">SOL SERIES 01</span>
          </div>

          <div className="hp-tier-control" role="radiogroup" aria-label="Pulsy pack tier">
          ...
          <p className="hp-action-note" aria-live="polite">
            Solana wallet connect is live in the UI. Real SOL payment and reward settlement need the Pulsy Solana program address before public openings are enabled.
          </p>
        </div>
        ...
        <motion.div
          ...
          role="radiogroup"
          aria-label="Choose a Pulsy pack"
        >
          {TIERS.map((option, index) => (
            <motion.button
              id={`pack-tier-${index}`}
            ...
            >
              <span className="hp-pack-card-index">PULSY.FUN / {option.label}</span>
              <span className={`hp-pack-card-art ${index === 0 ? "hp-pack-card-art-square" : ""}`}>
                <Image
                  src={option.image}
                  alt={`${option.name} Pulsy pack`}
      ...
      <section className="hp-status-rail" aria-label="Pulsy status">
      ...
      <section id="assets" className="hp-assets" aria-labelledby="assets-heading">
        <div className="hp-assets-head">
          <div>
            ...
            <h2 id="assets-heading">THE PULSY POOL,<br />ON SOLANA.</h2>
          </div>
        ...
        <p className="hp-assets-note">
          Pulsy is staged around SOL, ETH, ANSEM, and JIMOTHY. Live settlement should be enabled only after the Solana program and reserve vault are deployed.
        </p>
      </section>
      ...
      <section id="economics" className="hp-economics" aria-labelledby="economics-heading">
        ...
        <div className="hp-economics-grid">
          <div className="hp-economics-copy">
            ...
            <p>
              The intended Pulsy split keeps most SOL backing rewards, routes a slice to the jackpot, and leaves a small protocol margin.
            </p>
          </div>
          ...
          <div className="hp-ledger">
            ...
            <div><Check /><span>PROTOCOL</span><strong>10%</strong><small>Keeps Pulsy running</small></div>
          </div>
        </div>
      </section>
      ...
      <section id="proof" className="hp-proof" aria-labelledby="proof-heading">
        <div className="hp-proof-head">
          ...
          <span className="hp-proof-note">PULSY MIGRATION</span>
        </div>
        <div className="hp-proof-grid">
          ...
          <article><span>04</span><Zap /><h3>PROGRAM</h3><p>Enable live openings after the Pulsy program and vault addresses are public.</p></article>
        </div>
      </section>
      ...
      <section id="transparency" className="hp-transparency" aria-labelledby="transparency-heading">
        <div className="hp-proof-head">
          <div>
            <span className="hp-section-label">ARCHIVE / MIGRATION STATUS</span>
            <h2 id="transparency-heading">PAXZ IS ARCHIVED.<br />PULSY IS SOLANA.</h2>
          </div>
          <span className="hp-proof-note">ARCHIVE BRANCH</span>
        </div>
        <div className="hp-contract-grid">
          <a className="hp-contract-row" href="https://github.com/Jaredweb3here/pakz/tree/archive/paxz-before-pulsy" target="_blank" rel="noreferrer">
            <span className="hp-contract-label">Archived Paxz frontend</span>
            <code className="hp-contract-addr">archive/paxz-before-pulsy</code>
            <span className="hp-contract-note">Last Robinhood Chain version preserved before the Pulsy Solana migration.</span>
            <span className="hp-contract-cta">GITHUB <ExternalLink size={11} /></span>
          </a>
          <a className="hp-contract-row" href="https://solscan.io" target="_blank" rel="noreferrer">
            <span className="hp-contract-label">Pulsy Solana program</span>
      ...
      <footer className="hp-footer">
        <div className="hp-footer-top">
          <div>
            <span className="hp-section-label">PULSY ON SOLANA</span>
          ...
          <nav aria-label="Footer navigation">
            ...
            <a href="https://x.com/getpulsy_fun" target="_blank" rel="noreferrer">Community on X <ArrowUpRight size={18} /></a>
          </nav>
        </div>
        <div className="hp-footer-word" aria-hidden="true">PULSY</div>
        <div className="hp-footer-base">
          <p />
          <p>SOLANA / PULSY / PREVIEW</p>
          <div>
            <a href="https://x.com/getpulsy_fun" target="_blank" rel="noreferrer" aria-label="Pulsy on X">X</a>
            <SolWalletButton />
