...
export const metadata: Metadata = {
  ...
  description: "Pakz.fun protocol notes, reserve model, economics, and deployment status.",
};
  ...
  return (
    <main className="hp-shell hp-docs-shell">
      <header className="hp-header hp-docs-header">
        <HoodPackzBrand />
        <Link href="/" className="hp-docs-back"><ArrowLeft size={15} /> BACK TO DROPS</Link>
      </header>

      <section className="hp-docs-hero">
        <div>
          <span className="hp-section-label">PROTOCOL STATUS</span>
          <h1>LIVE DROPS.<br />PUBLIC RULES.</h1>
        </div>
        <p>
          Pakz.fun uses a fixed future Robinhood block hash with permissionless reveal.
          Only funded drops can open; locked drops stay closed until their reserves are ready.
        </p>
      </section>
      ...
      <section className="hp-docs-spec">
        <div><span>DROPS</span><strong>5 / 15 / 50 USDG</strong><p>Each opening resolves to three different reward tokens.</p></div>
      ...
      <section className="hp-docs-principles">
        ...
        <ul>
          ...
          <li><ShieldCheck size={18} /><span>Rewards are pre-funded and checked before a drop can accept payment.</span></li>
